...
> **Версия:** 1.4.1 | [Релизы](https://github.com/azagreev/life-planning-coach/releases) | [CHANGELOG](CHANGELOG.md)
...
1. Скачайте `life-planning-coach-v1.4.1.zip` из раздела [Релизы](https://github.com/azagreev/life-planning-coach/releases)
...
1. Скачайте `life-planning-coach-v1.4.1-grok.md`
...
2. Создайте агента → вставьте содержимое `life-planning-coach-v1.4.1-kimi.md` в системный промпт
