...
1. Скачайте `life-planning-coach-v0.13.0.zip` из [Релизов](https://github.com/azagreev/life-planning-coach/releases)
...
1. Скачайте `life-planning-coach-v0.13.0-grok.md`
...
2. Создайте агента → вставьте `life-planning-coach-v0.13.0-kimi.md` в системный промпт
