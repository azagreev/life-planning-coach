...
### WoL Health Sub-segments + Light Health Snapshot (PRD v1.0) — ✅ Shipped in v1.4.0
...
- **Статус:** ✅ **Shipped 2026-05-28 → v1.4.0**. Implementation: PR #30 (A), PR #31 (B), PR #32 (C). Schema 2.2.5 → 2.2.7. Все 3 sub-features merged.
