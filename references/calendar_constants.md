# Calendar Constants для Google Calendar MCP

> **Для Claude:** Используй эти константы во всех MCP-вызовах для календаря. Загрузи этот файл перед работой с календарём.
...
Google Tasks API недоступен через MCP. Daily Top-3 — чисто conversational:
