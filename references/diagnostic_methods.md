...
4. STYLE CALIBRATION (опционально, 1 минута):
   "Чтобы я мог поддерживать вас максимально комфортно — два коротких вопроса:
...
| Step | Что | Время |
|------|-----|-------|
| 1. Red Flag Detector | 6+1 quick screening | 2 мин |
| 2. Values Alignment | Оценка по топ-3 ценностям (1-10) | 2 мин |
| 3. Energy Check | Соматический маркер (опционально) | 2 мин |
| 4. Deep Why | 3 уровня "почему" | 3–5 мин |
| 5. Societal Pressure Test | 4 вопроса | 3–5 мин |
| 6. True Goal Score | Радар из 5 осей (ASCII) | 2 мин |
| **ИТОГО** | | **15–25 мин** |

**After ALL goals:**
| Step | Что | Время |
|------|-----|-------|
| 7. Pattern Analysis | 2+ цели с одним Red Flag | 2 мин |
| 8. Goal Portfolio | 🟢 Active + 🟡 On Pause + 🔍 Patterns | 2 мин |
...
| Аспект | v0.4.0 (монолитный) | v0.5.0 (Two-Track) | v0.6.0 (Authentic Goals) |
|--------|---------------------|--------------------|--------------------------|
| **Tracks** | 1 монолитный | 2: Quick + Deep | 2: Quick + Deep |
| **Stage 1.5** | Нет | Нет | ✅ Authentic Goal Filter + Portfolio |
| **Values метод** | Pairwise comparison (45 пар) | Top-5 → Top-3 | Top-5 → Top-3 |
| **Values вопросов** | ~50 | ~10 | ~10 |
| **Ikigai фреймворк** | 6 вопросов | 5 Pillars + 6 core | 5 Pillars + 6 core |
| **Life Story** | Обязательный (8–10 вопросов) | Опциональный (3 вопроса) | Опциональный (3 вопроса) |
| **Workview/Lifeview** | 250 слов эссе | 3 микро-вопроса | 3 микро-вопроса |
| **Odyssey Plans** | 3×5-7 пунктов | 3×3-5 пунктов | 3×3-5 пунктов |
| **Wheel of Life** | 8 доменов | 8 + 1 опц. | 11 доменов |
| **Communication Style** | Фиксированный | Фиксированный | ✅ Adaptive (Big Five × TTM × MI) |
| **Общее время** | 100–130 мин | Quick: 20–30 / Deep: 65–105 | + Stage 1.5: 15–25 мин |
| **Общее вопросов** | ~90–105 | Quick: ~20 / Deep: ~50–55 | + Stage 1.5: ~15 |
